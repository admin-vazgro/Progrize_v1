...
<reference>
@/Users/rohith/Desktop/job-match-ai/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/rohith/Desktop/job-match-ai/.claude/get-shit-done/references/user-profiling.md` to load:
