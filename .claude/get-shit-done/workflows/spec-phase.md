...
```bash
INIT=$(node "/Users/rohith/Desktop/job-match-ai/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/rohith/Desktop/job-match-ai/.claude/get-shit-done/templates/spec.md.
