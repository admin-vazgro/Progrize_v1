...
```
Task(
  prompt="Read /Users/rohith/Desktop/job-match-ai/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/rohith/Desktop/job-match-ai/.claude/get-shit-done/templates/SECURITY.md`
