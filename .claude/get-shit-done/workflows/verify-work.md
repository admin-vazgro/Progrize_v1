...
<template>
@/Users/rohith/Desktop/job-match-ai/.claude/get-shit-done/templates/UAT.md
</template>
...
Read and follow `/Users/rohith/Desktop/job-match-ai/.claude/get-shit-done/workflows/transition.md`.
...
```bash
node "/Users/rohith/Desktop/job-match-ai/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @/Users/rohith/Desktop/job-match-ai/.claude/get-shit-done/workflows/diagnose-issues.md
