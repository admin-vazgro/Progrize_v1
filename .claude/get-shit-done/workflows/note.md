...
- **Global scope**: `/Users/rohith/Desktop/job-match-ai/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/rohith/Desktop/job-match-ai/.claude/notes/`)
...
2. Glob `/Users/rohith/Desktop/job-match-ai/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/rohith/Desktop/job-match-ai/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/rohith/Desktop/job-match-ai/.claude/notes/` — works in any directory
